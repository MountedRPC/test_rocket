...
@admin.register(Indentrepreneur)
class IndentrepreneurAdmin(admin.ModelAdmin):
    ...
    def view_provider_link(self, obj):
        url = (
                reverse("admin:retailnetwork_retailnetwork_changelist")
                + "?"
...
class ProductsAdmin(admin.ModelAdmin):
    list_display = ("name", "model", "date", "idIndentrepreneur",)
